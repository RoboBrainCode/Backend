...
DATABASES = {
    'default': {
        ...
        'USER': '',
        'PASSWORD': '',
        'HOST': '54.68.112.33',# ec2-54-148-208-139.us-west-2.compute.amazonaws.com Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
